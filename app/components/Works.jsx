  ...
  return (
    <section className="py-20 bg-[#fafafa]">
      <div className="max-w-4xl mx-auto px-5">
        ...
        <div className="mb-10">
          <h2 className="text-[26px] font-semibold">Featured works</h2>
        </div>
        ...
        <div className="flex flex-col gap-6">
          <WorkCard
            ...
            year="2026"
            tech="React"
            description="Portfólio desenvolvido em React com foco em layout limpo e responsivo."
          />

          <WorkCard
            image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxSUVSDn64Y1UYgkpdpfLAnvZ-h821DKT4NP3bcRSXLDgkGUxWJQslhAk&s"
            title="Landing Page"
            year="2025"
            tech="HTML • CSS • JS"
            description="Landing page moderna com boas práticas de front-end."
          />

          <WorkCard
            image="https://media.licdn.com/dms/image/v2/D4D12AQFOxJ_edtjaWQ/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1698062004022?e=2147483647&v=beta&t=WcJqK1xg-XWsZSPBf9Dm78Fz1ZHQtf9-eCl9pix6IS0"
            title="Dashboard"
            year="2025"
            tech="Next.js"
            description="Dashboard com layout organizado e foco em usabilidade."
          />
        </div>
